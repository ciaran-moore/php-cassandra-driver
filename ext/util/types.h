...
php8_zval php_driver_type_from_data_type(const CassDataType *data_type);
...
php8_zval php_driver_type_scalar(CassValueType type);
const char* php_driver_scalar_type_name(CassValueType type);

php8_zval php_driver_type_set(zval *value_type);
php8_zval php_driver_type_set_from_value_type(CassValueType type);

php8_zval php_driver_type_collection(zval *value_type);
php8_zval php_driver_type_collection_from_value_type(CassValueType type);

php8_zval php_driver_type_map(zval *key_type,
                                    zval *value_type);
php8_zval php_driver_type_map_from_value_types(CassValueType key_type,
                                                  CassValueType value_type);

php8_zval php_driver_type_tuple();

php8_zval php_driver_type_user_type();

php8_zval php_driver_type_custom(const char *name,
                                    size_t name_length);
