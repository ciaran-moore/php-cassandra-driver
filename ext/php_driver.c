...
PHP_INI_MH(OnUpdateLogLevel)
{
  ...
  if (new_value) {
    if (PHP8_STRCMP(new_value, "CRITICAL") == 0) {
      cass_log_set_level(CASS_LOG_DISABLED);
    } else if (PHP8_STRCMP(new_value, "ERROR") == 0) {
      cass_log_set_level(CASS_LOG_ERROR);
    } else if (PHP8_STRCMP(new_value, "WARN") == 0) {
      cass_log_set_level(CASS_LOG_WARN);
    } else if (PHP8_STRCMP(new_value, "INFO") == 0) {
      cass_log_set_level(CASS_LOG_INFO);
    } else if (PHP8_STRCMP(new_value, "DEBUG") == 0) {
      cass_log_set_level(CASS_LOG_DEBUG);
    } else if (PHP8_STRCMP(new_value, "TRACE") == 0) {
...
PHP_INI_MH(OnUpdateLog)
{
  ...
  if (new_value) {
    if (PHP8_STRCMP(new_value, "syslog") != 0) {
      char realpath[MAXPATHLEN + 1];
      if (VCWD_REALPATH(PHP8_STRVAL(new_value), realpath)) {
        log_location = strdup(realpath);
      } else {
        log_location = strdup(PHP8_STRVAL(new_value));
      }
    } else {
      log_location = strdup(PHP8_STRVAL(new_value));
    }
...
static PHP_GINIT_FUNCTION(php_driver)
{
  ...
  PHP8_ZVAL_UNDEF(php_driver_globals->type_varchar);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_text);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_blob);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_ascii);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_bigint);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_smallint);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_counter);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_int);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_varint);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_boolean);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_decimal);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_double);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_float);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_inet);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_timestamp);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_uuid);
  PHP8_ZVAL_UNDEF(php_driver_globals->type_timeuuid);
}
...
#define XX_SCALAR(name, value) \
  PHP8_ZVAL_UNDEF(PHP_DRIVER_G(type_##name));
...
{
#define XX_SCALAR(name, value) \
  PHP8_ZVAL_MAYBE_DESTROY(PHP_DRIVER_G(type_##name));
